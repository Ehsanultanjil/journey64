          ...
          <div className="max-w-md w-full bg-[#111111] border border-red-500/30 p-8 shadow-2xl space-y-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <button
                ...
                className="w-full py-3 bg-[#004526] hover:bg-[#005a32] text-white font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer flex items-center justify-center gap-2 rounded-xl shadow-lg shadow-[#004526]/25"
              >
