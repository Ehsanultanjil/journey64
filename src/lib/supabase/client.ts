...
const supabaseUrl = (import.meta as any).env?.VITE_SUPABASE_URL || 'https://gdqcjcogpymuwfivoeok.supabase.co';
const supabaseAnonKey = (import.meta as any).env?.VITE_SUPABASE_ANON_KEY || 'sb_publishable_TbnmvgWB1jz8VvwroR0IOA_UnOlajaR';
